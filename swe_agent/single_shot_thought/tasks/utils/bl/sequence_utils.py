# swe_agent/tasks/utils/bl/sequence_utils.py
# Copied from HyperAgent reference implementation
...
def repeated_subsequences(sequence, min_repetition=5, prefix=None):
    ...
    Example:
        ...
        Output: [{'subsequence': [5, 2], 'start': 10, 'end': 29, 'num_repetition': 10, 'subsequence_length': 2, 'total_length': 20},
                 {'subsequence': [1], 'start': 4, 'end': 7, 'num_repetition': 4, 'subsequence_length': 1, 'total_length': 4}]
    """
    subsequences = []
