...
"""
Single-Shot Thought: Multi-Baseline Prompting-Strategy APR for Defects4J

Prompting strategies: standard, cot, zero_shot_cot, few_shot_cot, react,
reflexion, self_consistency, tot, got, pot, function_calling

All defects4j operations go through the Docker web API (no local D4J_HOME needed).
"""

from .config import (
    D4J_HOME, D4J_FOLDER, REPOS_DIR, WORKSPACE_ROOT,
    OPENAI_API_KEY, OPENAI_API_BASE_URL, GPT_MODEL,
...
__version__ = "1.1.0"
__all__ = [
    "D4J_FOLDER", "REPOS_DIR", "WORKSPACE_ROOT",
    "OPENAI_API_KEY", "OPENAI_API_BASE_URL", "GPT_MODEL",
    "MAX_ATTEMPTS_PER_BUG", "MAX_LLM_CALLS_PER_ATTEMPT", "MAX_LLM_CALLS_PER_BUG",
    "MAX_TOKENS_PER_BUG", "MAX_PATCH_LINES", "MAX_FILES_CHANGED",
    "BASELINES",
